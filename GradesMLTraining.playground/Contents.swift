...
let csvFile = Bundle.main.url(forResource: "GradesTrainingData", withExtension: "csv")!
let dataTable = try MLDataTable(contentsOf: csvFile)

print(dataTable)

let regressorColumns = ["Subject", "Type", "Grade"]
...
let regressorMetadata = MLModelMetadata(author: "Gustavo Garfias",
                                        shortDescription: "Predicts the grade of a student according to subject and type.",
                                        version: "1.1")

try regressor.write(to: desktopPath.appendingPathComponent("GradesPredicter1-1.mlmodel"),
